module.exports = [
"[project]/src/app/admin/groups/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GroupsPage() {
    ...
    const fetchGroups = async ()=>{
        try {
            setLoading(true);
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('kpop_groups').select('*');
            // 搜尋
            if (searchQuery) {
    ...
    const handleDelete = async (groupId, groupName)=>{
        ...
        try {
            // 檢查是否有關聯的歌曲
            const { data: songs } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('song_group').select('song_id').eq('group_id', groupId).limit(1);
            if (songs && songs.length > 0) {
                alert('無法刪除：此團體有關聯的歌曲，請先刪除相關歌曲。');
                return;
            }
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('kpop_groups').delete().eq('group_id', groupId);
            if (error) throw error;
            alert('團體已成功刪除');
            fetchGroups();
        } catch (error) {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: [
                                                ...
                                                group.group_namekr && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
